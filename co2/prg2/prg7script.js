...
break; case 4: init_content += "<caption><h1>MAY<h1></caption>"; 
break;
...
break;
 case 8: init_content += "<caption><h1>SEPTEMBER<h1></caption>"; 
break;
...
break;
 ...
 var date = new Date(year_get, 
month_get); var day = date.getDay(); 
for (var i = 0; i < day; i++) {
 init_content += "<td></td>";
 }
